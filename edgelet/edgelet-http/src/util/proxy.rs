...
use super::{hyperwrap::Client, super::client::ClientImpl};
use error::Error;
...
#[cfg(test)]
mod tests {
    use super::{MaybeProxyClient, super::super::client::ClientImpl};
    use futures::Future;
    use http::Request;
    ...
    fn client_calls_underlying_service() {
        ...
        assert_eq!(response.status(), StatusCode::from_u16(234).expect("StatusCode::from_u16 should not fail"));
    }
}
