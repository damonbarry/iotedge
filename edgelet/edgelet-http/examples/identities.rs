...
fn index(_req: Request<Body>, _params: Parameters) -> Box<Future<Item = Response<Body>, Error = HyperError> + Send> {
...
fn main() {
    ...
    tokio::runtime::current_thread::Runtime::new().unwrap().block_on(run).unwrap();
}
