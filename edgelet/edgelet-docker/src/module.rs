...
mod tests {
    ...
    fn module_status() {
        ...
        for &(docker_status, exit_code, ref module_status) in inputs.iter() {
            ...
            let state = tokio::runtime::current_thread::Runtime::new().unwrap().block_on(docker_module.runtime_state()).unwrap();
    ...
    fn module_runtime_state() {
        ...
        let runtime_state = tokio::runtime::current_thread::Runtime::new().unwrap().block_on(docker_module.runtime_state()).unwrap();
