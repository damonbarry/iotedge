...
namespace Microsoft.Azure.Devices.Edge.Hub.Core.Test
{
    ...
    public class DeviceMessageHandlerTest
    {
        ...
        public async Task ForwardsGetTwinOperationToEdgeHub()
        {
            ...
            var listener = new DeviceMessageHandler(identity, edgeHub.Object, connMgr, null, DefaultMessageAckTimeout, Option.None<string>());
        ...
        public async Task ProcessMessageBatchAsync_WithModelIdAsyncTest()
        {
            ...
            var deviceListener = new DeviceMessageHandler(identity, edgeHub, connectionManager, null, DefaultMessageAckTimeout, Option.Some("testModelId"));
        ...
        public async Task ProcessMessageBatchAsync_RouteAsyncTest()
        {
            ...
            messages.Add(Mock.Of<IMessage>());
            Mock.Get(connectionManager).Setup(c => c.GetCloudConnection(It.IsAny<string>())).Returns(Task.FromResult(Option.Some(cloudProxy)));
            var deviceListener = new DeviceMessageHandler(identity, edgeHub, connectionManager, null, DefaultMessageAckTimeout, Option.None<string>());
            await deviceListener.ProcessDeviceMessageBatchAsync(messages);
        ...
        public async Task MessageCompletionTest()
        {
            ...
            var deviceMessageHandler = new DeviceMessageHandler(identity, edgeHub, connMgr.Object, null, DefaultMessageAckTimeout, Option.None<string>());
        ...
        public async Task MessageCompletionShortAckTimeoutTest()
        {
            ...
            var deviceMessageHandler = new DeviceMessageHandler(identity, edgeHub, connMgr.Object, null, messageAckTimeout, Option.None<string>());
            deviceMessageHandler.BindDeviceProxy(underlyingDeviceProxy.Object);
